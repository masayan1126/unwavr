  ...
  return (
    <div className="p-6 sm:p-10 max-w-4xl mx-auto flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-2 px-2 py-1 rounded border border-black/10 dark:border-white/10">
        ...
        <div className="h-6 w-16 rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 animate-pulse" />
        <div className="h-6 w-20 rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 animate-pulse" />
      </div>
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          <div className="h-9 w-40 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
