          ...
          <div className="px-6 py-4 border-t border-black/10 dark:border-white/10 flex justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleSave}
                disabled={!title.trim() || isSubmitting}
                className="px-6 py-2 text-sm bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
              >
                {isSubmitting ? "保存中..." : "保存"}
              </button>
            </div>
